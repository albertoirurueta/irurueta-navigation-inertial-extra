 ...
 */
public interface GyroscopeIntervalDetectorThresholdFactorOptimizerDataSource extends
        IntervalDetectorThresholdFactorOptimizerDataSource<TimedBodyKinematics> {
}
