...
public class BracketedGyroscopeIntervalDetectorThresholdFactorOptimizerTest implements
    ...
    public void testConstructor1() {
        ...
        assertEquals(BrentSingleOptimizer.class,
                optimizer.getMseOptimizer().getClass());
    ...
    public void testConstructor3() {
        ...
        BracketedGyroscopeIntervalDetectorThresholdFactorOptimizer optimizer =
                new BracketedGyroscopeIntervalDetectorThresholdFactorOptimizer(
                        calibrator);
        ...
        optimizer = null;
        try {
            optimizer = new BracketedGyroscopeIntervalDetectorThresholdFactorOptimizer(
    ...
    public void onOptimizeStart(
            final IntervalDetectorThresholdFactorOptimizer<TimedBodyKinematics, GyroscopeIntervalDetectorThresholdFactorOptimizerDataSource> optimizer) {
        mStart++;
