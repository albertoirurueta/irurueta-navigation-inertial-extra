...
public class BracketedAccelerometerAndGyroscopeIntervalDetectorThresholdFactorOptimizerTest implements
    ...
    public void testConstructor1() {
        ...
        assertEquals(DefaultAccelerometerAndGyroscopeMseRule.class,
    ...
    public void testConstructor3() {
        ...
        BracketedAccelerometerAndGyroscopeIntervalDetectorThresholdFactorOptimizer optimizer =
                new BracketedAccelerometerAndGyroscopeIntervalDetectorThresholdFactorOptimizer(
        ...
        optimizer = null;
        try {
            optimizer = new BracketedAccelerometerAndGyroscopeIntervalDetectorThresholdFactorOptimizer(
    ...
    public void testGetSetMseRule() throws LockedException {
        ...
        // set new value
        final AccelerometerAndGyroscopeMseRule rule =
                mock(AccelerometerAndGyroscopeMseRule.class);
