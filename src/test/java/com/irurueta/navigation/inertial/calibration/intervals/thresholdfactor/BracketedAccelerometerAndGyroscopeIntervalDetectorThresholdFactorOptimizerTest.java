...
class BracketedAccelerometerAndGyroscopeIntervalDetectorThresholdFactorOptimizerTest implements
    ...
    private final AccelerometerAndGyroscopeMeasurementsGeneratorListener generatorListener =
            new AccelerometerAndGyroscopeMeasurementsGeneratorListener() {
                ...
                public void onGeneratedGyroscopeMeasurement(
                    ...
                    gyroscopeGeneratorMeasurements.add(measurement);
                }
    ...
    void testConstructor2() {
        final var dataSource = mock(AccelerometerAndGyroscopeIntervalDetectorThresholdFactorOptimizerDataSource.class);
    ...
    void testConstructor4() {
        ...
        final var optimizer = new BracketedAccelerometerAndGyroscopeIntervalDetectorThresholdFactorOptimizer(dataSource, 
                accelerometerCalibrator, gyroscopeCalibrator);
    ...
    void testOptimizeMaCommonAxisWithNoise() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (TimedBodyKinematics timedBodyKinematics : timedBodyKinematics) {
            ...
            for (final var timedBodyKinematics : timedBodyKinematics) {
                assertTrue(generator.process(timedBodyKinematics));
            }

            // use generated measurements from a generator that used an optimal threshold factor
